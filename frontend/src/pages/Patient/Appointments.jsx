          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl max-w-md w-full">
            <div className="p-6">
              ...
              <p className="text-gray-600 dark:text-gray-400 text-center mb-6">
                Are you sure you want to cancel this appointment? Refunds are processed automatically based on our 24-hour full-refund window. You can track this in your payment history.
              </p>
