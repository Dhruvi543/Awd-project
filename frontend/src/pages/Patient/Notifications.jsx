...
const PatientNotifications = () => {
  ...
  const getNotificationIcon = (message) => {
    if (message.toLowerCase().includes('approved') || message.toLowerCase().includes('confirmed')) {
      return (
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8 flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400">Stay updated with your appointment status</p>
          </div>
          {unreadCount > 0 && (
            <button
