      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {isLoading ? (
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-8 text-center">
            ...
            <p className="text-gray-500 dark:text-gray-400">Loading Terms & Conditions...</p>
          </div>
        ) : error ? (
              ...
              <div className="flex flex-wrap items-center justify-between gap-2 text-sm">
                <div className="flex items-center gap-4">
                  <span className="text-blue-900 dark:text-blue-300">
                    ...
                    <span className="font-bold">{termsData.version}</span>
                  </span>
              ...
              <div className="prose dark:prose-invert max-w-none">
                {termsData.content ? (
                  ...
                  <div className="text-center py-8 text-gray-500 dark:text-gray-400">
                    <p>No Terms & Conditions content available.</p>
                  </div>
                )}
              </div>
            </div>
            ...
            <div className="bg-gray-50 dark:bg-gray-700/50 border-t border-gray-200 dark:border-gray-700 px-6 py-4">
              <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                <p className="text-sm text-gray-500 dark:text-gray-400 text-center sm:text-left">
                  By using DOXI Healthcare Platform, you agree to these Terms & Conditions.
                </p>
        ...
        <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
            <h3 className="font-semibold text-gray-900 dark:text-white mb-2">For Doctors</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Doctors must accept these terms before using the platform.{' '}
