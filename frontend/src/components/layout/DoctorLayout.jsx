...
const DoctorLayout = () => {
  ...
  const getSearchPlaceholder = () => {
    ...
    if (path.includes('/appointments')) return 'Search appointments by date, patient, status...';
    if (path.includes('/reviews')) return 'Search reviews by patient, rating...';
    if (path.includes('/availability')) return 'Search availability by date, time...';
    if (path.includes('/calendar')) return 'Search calendar events...';
    return 'Search appointments, patients, reviews...';
  };
