...
const PatientLayout = () => {
  ...
  const menuItems = [
    ...
    { path: '/patient/appointments', label: 'Appointments', icon: 'appointments' },
    { path: '/patient/find-doctor', label: 'Find Doctor', icon: 'doctors' },
    { path: '/patient/reviews', label: 'Review & Rating', icon: 'reviews' },
    { path: '/patient/availability', label: 'Doctor Availability', icon: 'availability' },
  ...
  const getSearchPlaceholder = () => {
    ...
    if (path.includes('/appointments')) return 'Search appointments by date, doctor, status...';
    if (path.includes('/find-doctor')) return 'Search doctors by name, specialty, location...';
    if (path.includes('/reviews')) return 'Search reviews by doctor, rating...';
    if (path.includes('/availability')) return 'Search doctor availability by date, time...';
    return 'Search appointments, doctors, reviews...';
  };
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex transition-colors duration-200">
      ...
      >
        ...
        <div className="h-16 border-b border-blue-200 dark:border-gray-600 flex items-center justify-between bg-white dark:bg-gray-800 px-4">
          {sidebarOpen && (
            <Link to="/patient/dashboard" className="flex items-center flex-1 h-full">
              <img
                src={logo}
                alt="DOXI"
              ...
              />
              <span className="ml-3 text-xl font-bold text-blue-600 dark:text-blue-400">DOXI Patient</span>
            </Link>
          )}
          {!sidebarOpen && (
            <Link to="/patient/dashboard" className="flex items-center justify-center w-full h-full">
              <img
                src={logo}
                alt="DOXI"
                className="h-14 w-14 object-contain"
            ...
            <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center space-x-2 pl-3 border-l border-gray-200 dark:border-gray-700">
                ...
                <div className="hidden md:block text-left">
                  <p className="text-sm font-medium text-gray-900 dark:text-white">{user?.name || 'Patient'}</p>
